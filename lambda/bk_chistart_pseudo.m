function [Chi2,afixed] = bk_chistart_pseudo(D,L,a,ncands,qfactor)
  ...
  for k = n:-1:0;
	...
	afixed(i,:) = round (afloat(i,:));
        ...
        for v = 1:npseudo
          ...
          if (afloat(i,v) == afixed(i,v));
            afixed(i,v) = afixed(i,v) + 1;
          else;
            afixed(i,v) = round (afloat(i,v) + sign (afloat(i,v) - afixed(i,v)));
          end

function Chi2 = chistart_freek (D,L,a,ncands,factor)
...
%
% Adapted by Freek van Leijen, 05-OCT-2004 to compute only one
% candidate (the original bootstrap solution). This is especially
% much faster with a large number of ambiguities and the original
% solution is often (however not always!) the best.
%
% ----------------------------------------------------------------------
...
if ncands <= n+1;
  ...
  Chi = (a-afixed)' * inv(L'*diag(D)*L) * (a-afixed);

function Chi2 = chistart_freek_5cand (D,L,a,ncands,factor)
...
%
% Adapted by Freek van Leijen, 05-OCT-2004 to compute only 5
% candidates. This is especially much faster with a large number 
% of ambiguities.
% ----------------------------------------------------------------------

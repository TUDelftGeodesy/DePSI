function ps_visualize_ps(Nifgs,Nps,Npsc,Npsc_selections,final_model)
...
for z = 1:Npsc_selections
  ...
  for v = 1:Npar
      ...
      print('-dpng',['plots/' project_id '_ps_parameter_' char(ps_annotation(par_index(v))) '_model' num2str(final_model) '_sel' num2str(z) '_' results_id '.png'])
      close(fig);
  end
  ...
  print('-dpng',['plots/' project_id '_ps_parameter_ens_coh_model' num2str(final_model) '_sel' num2str(z) '_' results_id '.png'])
  close(fig);
  ...
  print('-dpng',['plots/' project_id '_ps_parameter_ens_coh_local_model' num2str(final_model) '_sel' num2str(z) '_' results_id '.png'])
  close(fig);
